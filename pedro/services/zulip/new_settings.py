...
import ldap
from django_auth_ldap.config import GroupOfUniqueNamesType, LDAPGroupQuery, LDAPSearch  # noqa: F401
...
AUTH_LDAP_USER_SEARCH = LDAPSearch(
    "ou=users,DC=ldap,DC=fsim", ldap.SCOPE_SUBTREE, "(|(cn=%(user)s)(mail=%(user)s))"
)
...
AUTH_LDAP_REVERSE_EMAIL_SEARCH = LDAPSearch("ou=users,DC=ldap,DC=fsim",
                                            ldap.SCOPE_SUBTREE, "(&(mail=%(email)s)(department=IM))")
...
AUTH_LDAP_GROUP_SEARCH = LDAPSearch(
    "ou=groups,dc=ldap,dc=fsim", ldap.SCOPE_SUBTREE, "(objectClass=groupOfUniqueNames)"
)
...
SOCIAL_AUTH_OIDC_ENABLED_IDPS: dict[str, Any] = {
    ...
    "idp_name": {
        ...
        "oidc_url": "https://idp.fsim-ev.de/application/o/zulip/",
        ...
        "client_id": "BNgaeWaqUKZRPsWcTg4UFwGoWWBWhmuaf4JbkweK",
        # "secret": get_secret("social_auth_oidc_secret"),
        "secret": "ltLAtPLJyR1iqaRbGyj7nnRr3LefR0StA7pzQvP4OfdQAZu6WazRzywGlUiLh0zQJGAgQSxJyQaQUppAyI21i9THFfhSZkjHWZGESBMmSUTCb4k1TPXynb8ZnlZjqRMq",
...
SOCIAL_AUTH_SAML_ENABLED_IDPS: dict[str, Any] = {
    ...
    "idp_name": {
        ...
        "entity_id": "https://idp.fsim-ev.de",
        "url": "https://idp.fsim-ev.de/application/saml/zulip/sso/binding/redirect/",
        ##
        ...
        "attr_user_permanent_id": "kennung",
